...
const DeliveryScreen = () => {
    ...
    return (
        <View className="bg-[#00ccbb] flex-1">
            ...
            <SafeAreaView className="bg-white flex-row items-center space-x-4 h-32">
                <Image
                    source={{ uri: "https://links.papareact.com/wru" }}
                    className="h-12 w-12 bg-white p-4 rounded-full ml-5"
                />
                <View className="flex-1">
                    <Text className="text-lg">Chrish Van</Text>
